...
photo_action = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Ігрової категорії', callback_data='gmphoto')],
    [InlineKeyboardButton(text='Підкатегорії', callback_data='ingphoto')],
    [InlineKeyboardButton(text='Товару', callback_data='itemphoto')]])
